...
For every vertical HeyGen source video, apply `HEYGEN_VERTICAL_REELS.md` before editing the composition.

The default design/process is:
- 1080x1920, 9:16 output
- HeyGen video remains the base layer with original audio
- cutaway coverage target is about 50%
- all overlay cards are centered and the same height: 70%
