...
class User(Base):
    ...
    thumbnail_auto_approve_enabled = Column(Boolean, default=False, nullable=False)
    ...
    avatar_overlay_x_percent = Column(Integer, default=70, nullable=False)
    avatar_overlay_y_percent = Column(Integer, default=100, nullable=False)
    avatar_overlay_size_percent = Column(Integer, default=61, nullable=False)
    avatar_overlay_opacity_percent = Column(Integer, default=100, nullable=False)
    reels_broll_yandex_dir = Column(String, default="disk:/Видео для REELS", nullable=False)
...
class PostMyPostProjectSetting(Base):
    ...
    publish_limit_per_day = Column(Integer, default=3, nullable=False)
    vizard_limit_per_day = Column(Integer, default=1, nullable=False)
...
class CarouselDraft(Base):
    ...
    slide_count = Column(Integer, default=1, nullable=False)
    story_slide_count = Column(Integer, default=1, nullable=False)
    reference_paths = Column(JSON, nullable=True)
    story_reference_paths = Column(JSON, nullable=True)
    platform_accounts = Column(JSON, nullable=False)
    ctas = Column(JSON, nullable=True)
    platform_texts = Column(JSON, nullable=True)
    story_ctas = Column(JSON, nullable=True)
    slides = Column(JSON, nullable=True)
    story_slides = Column(JSON, nullable=True)
