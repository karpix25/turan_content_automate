...
def build_integrated_card_prompt(
    *,
    ...
    prompt = (
        ...
        "Use the provided Instagram post only as a content/style reference. Build a new clean Russian infographic card "
        ...
        "of a dark-haired bearded man pointing toward the CTA or content. The person must not cover important text.\n\n"
