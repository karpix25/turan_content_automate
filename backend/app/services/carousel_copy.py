...
def build_reference_rewrite_prompt(posts: list[dict], author_style: str | None) -> list[dict]:
    ...
    content: list[dict] = [{
        ...
        "text": (
            ...
            " Ориентируйся на 120–350 слов, но сохраняй все самостоятельные пункты обещанного разбора."
            " Если в источнике пять приёмов, раскрой все пять отдельными смысловыми абзацами."
            " Не склеивай третий и четвёртый пункты и не оставляй продолжение первого после пятого."
            " Если источник неполный, убери невыполненное числовое обещание; не выдумывай недостающие пункты."
            " Возьми одну главную тему источника и раскрой её плотно,"
